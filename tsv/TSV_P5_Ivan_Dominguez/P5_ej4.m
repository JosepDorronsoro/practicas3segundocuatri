...
umbrales = [0.0133-0.01, 0.0133, 0.0133+0.01];
sigmas = [1.6-0.5, 1.6, 1.6+0.5];

for u=umbrales

for s=sigmas

SIFTpoints = detectSIFTFeatures(ima, ContrastThreshold=u, Sigma=s); 
...
figure('Name', sprintf('T: %.4f, S: %.4f', u, s));
