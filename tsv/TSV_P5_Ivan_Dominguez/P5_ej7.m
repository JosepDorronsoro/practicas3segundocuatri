%% P5 - Ej 7 Correspondecias SIFT (plantilla)
...
[matches_12, scores_12] = my_nndr_match(selected_features_1, selected_features_2);
% Cálculo correspondencias entre imágenes 3-2
[matches_32, scores_32] = my_nndr_match(selected_features_3, selected_features_2);
