function h = vl_plotframe_forMatlabSIFTpoints(points,varargin)
...
% Matlab 0 is x axis (right) and counterclockwise; vlt is y axis (down) and
% clockwise
points.Orientation=(3*pi/2)-(points.Orientation);

frames=[ points.Location(:,1)'; points.Location(:,2)'; points.Scale'; points.Orientation'];

%%function h = vl_plotframe_forMatlabSIFTpoints(frames,varargin)
