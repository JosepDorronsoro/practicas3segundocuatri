...
plot(...
title(sprintf('Mejores %d Correspondencias %d puntos SIFT entre imagen 1 y 2', length(Best_ind12), points2view(p2w)))
...
% plot las líneas entre parejas de puntos '-'
plot(...
title(sprintf('Mejores %d Correspondencias %d puntos SIFT entre imagen 2 y 3', length(Best_ind32), points2view(p2w)))
